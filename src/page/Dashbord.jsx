...
const Dashboard = () => {
    ...
    const menuItems = [
        ...
        { id: 'profiles', label: 'See All Profiles', icon: Users },
        { id: 'create', label: 'My Create', icon: BookOpen },
                    ...
                    <header className={`bg-gray-200 dark:bg-gray-900 border-b border-gray-300 dark:border-gray-800 p-6 transition-all duration-700 transform ${isLoaded ? 'translate-y-0 opacity-100' : '-translate-y-10 opacity-0'}`}>
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-4">
                                {/* <button
                                    onClick={toggleTheme}
                                    className="p-2 bg-gray-300 dark:bg-gray-800 rounded-lg hover:scale-110 transition"
                                >
